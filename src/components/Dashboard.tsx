  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-fadeIn pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-3 bg-slate-50/90 border border-slate-200/90 rounded-3xl p-6 space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex overflow-x-auto gap-2 pt-2 border-t border-slate-200 pb-1">
            {/* Feature 1 */}
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
            ...
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">Study Planner</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">Track & Improve</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">Smart Revision</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">Confidence Check</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-1 p-2 rounded-2xl hover:bg-slate-100/50 transition-colors flex-shrink-0 w-20">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">Multi-Format Support</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Welcome Banner */}
          <div className="bg-slate-50/90 border border-slate-200 rounded-3xl p-6 relative overflow-hidden shadow-xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mt-6">
              ...
              <div className="bg-white/80 border border-slate-200 rounded-2xl p-3.5 text-center space-y-1">
                <div className="w-7 h-7 rounded-xl bg-indigo-500/20 text-indigo-400 mx-auto flex items-center justify-center">
                  <FileText className="w-3.5 h-3.5" />
                </div>
                <span className="text-[10px] font-bold text-slate-600 block uppercase tracking-wider">Total Quizzes</span>
              ...
              <div className="bg-white/80 border border-slate-200 rounded-2xl p-3.5 text-center space-y-1">
                ...
                <span className="text-[10px] font-bold text-slate-600 block uppercase tracking-wider">Correct Answers</span>
              ...
              <div className="bg-white/80 border border-slate-200 rounded-2xl p-3.5 text-center space-y-1">
                ...
                <span className="text-[10px] font-bold text-slate-600 block uppercase tracking-wider">Wrong Answers</span>
              ...
              <div className="bg-white/80 border border-slate-200 rounded-2xl p-3.5 text-center space-y-1">
                ...
                <span className="text-[10px] font-bold text-slate-600 block uppercase tracking-wider">Need Improve</span>
              ...
              <div className="bg-white/80 border border-slate-200 rounded-2xl p-3.5 text-center space-y-1">
                ...
                <span className="text-[10px] font-bold text-slate-600 block uppercase tracking-wider">Confident</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="bg-slate-50/90 border border-slate-200 rounded-3xl p-6 space-y-4 flex flex-col justify-between shadow-xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider">Smart Revision</h3>
          </div>

          {/* Filter Tabs */}
          <div className="flex items-center space-x-2 p-1 bg-white rounded-xl border border-slate-200">
            <button
          ...
          <div className="space-y-2.5">
            <div className="p-3 rounded-2xl bg-white border border-slate-200 space-y-1.5 text-xs">
              <p className="font-bold text-slate-800">1. What is the slump test used for?</p>
            ...
            <div className="p-3 rounded-2xl bg-white border border-slate-200 space-y-1.5 text-xs">
              <p className="font-bold text-slate-800">2. Which cement is used for mass concrete?</p>
              <div className="flex items-center justify-between text-[11px]">
        ...
        <div className="bg-slate-50/90 border border-slate-200 rounded-3xl p-6 space-y-4 flex flex-col justify-between shadow-xl">
          <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider">Performance Overview</h3>
          ...
          <p className="text-[11px] text-center text-slate-600 font-semibold pt-1 border-t border-slate-200">
      ...
      <div className="bg-slate-50/90 border border-slate-200 rounded-3xl p-5 overflow-x-auto shadow-xl">
