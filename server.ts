...
// New 3-page rebuild: upload+analyze, exam submit, performance review, suggestions.
// Everything under here requires either a logged-in user or a guest session (see identifyOwner).
